...
public class InteractorModule {
    ...
    SignInInteractor provideSignInInteractor(UserRepository userRepository,
            @Named(SUBSCRIBER_SCHEDULER) Scheduler scheduler,
    ...
    TopicMessagesInteractor provideTopicMessagesInteractor(
            TopicMessagesRepository topicMessagesRepository, UserRepository userRepository,
            @Named(SUBSCRIBER_SCHEDULER) Scheduler scheduler,
            @Named(OBSERVER_SCHEDULER) Scheduler observerScheduler) {
        return new TopicMessagesInteractorImpl(topicMessagesRepository, userRepository, scheduler,
                observerScheduler);
    }
}
